...
public class TwoOrMoreViewModelMockitoTest {
  ...
  public void allDifferent() {
    ...
    m.setWager(15);
    m.play();
    assertThat(m.balance(), is(205));
  }
  @Test
  public void testTwoAlikeWinningScenario() {
    ...
    m.setWager(25);
    m.play();
    assertThat(m.balance(), is(350));
  }

  @Test
  public void testThreeAlikeWinningScenario() {
    ...
    m.setWager(35);
    m.play();
    assertThat(m.balance(), is(605));
  }

  @Test
  public void testFourAlikeWinningScenario() {
    ...
    m.setWager(40);
    m.play();
    assertThat(m.balance(), is(760));
  }

  @Test
  public void testFourAlikeLosingScenario() {
    when(d1.value()).thenReturn(2);
    when(d2.value()).thenReturn(2);
    when(d3.value()).thenReturn(2);
